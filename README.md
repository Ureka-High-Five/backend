...
- **사용자 행동 로그 수집 및 분석 인프라 구축**
  ...
  - Elasticsearch에 **ECS(Elastic Common Schema)** 기반 인덱스 색인
...
<img width="1772" height="1122" alt="image" src="https://github.com/user-attachments/assets/856a330e-e0ed-4a31-b5fb-ab37ecee43ed" />
