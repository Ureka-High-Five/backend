...
import static org.highfive.backend.global.code.ErrorCode.*;
...
public class KakaoOAuthClient {
    ...
    private WebClient.ResponseSpec handleResponse(final WebClient.ResponseSpec responseSpec, final ErrorCode errorCode) {
